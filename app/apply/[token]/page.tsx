...
export default function ApplyPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (error && !application) {
    return (
      <div className="min-h-screen bg-[#080A0E] flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-[#111620] border border-[#1E2530] rounded-2xl p-8 text-center">
  ...
  // Application form
  return (
    <div className="min-h-screen bg-[#080A0E] py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-[#111620] border border-[#1E2530] rounded-xl p-6">
          ...
          {/* Consent */}
          <div className="bg-[#111620] border border-[#1E2530] rounded-xl p-6">
            <p className="text-xs text-[#6B7280] leading-relaxed" style={{ fontFamily: 'DM Sans, sans-serif' }}>
          ...
          <p className="text-center text-[10px] text-[#6B7280]/60" style={{ fontFamily: 'DM Sans, sans-serif' }}>
...
function FormInput({
  ...
  return (
    <div className={wrapperClass}>
      <label className="block text-xs text-[#6B7280] mb-1.5" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        {label}
      </label>
      <input
        type={type}
        ...
        className={cn(
          ...
          'bg-[#080A0E] border border-[#1E2530]',
